...
public class LoginActivity extends AppCompatActivity {
    ...
    void simpanFileLogin() {
        ...
        Toast.makeText(this, "Login Berhasil yaa..", Toast.LENGTH_SHORT).show();
    ...
    void login() {
        ...
        if (file.exists()) {
            ...
            if (dataUser[1].equals(etPassword.getText().toString())) {
                simpanFileLogin();
                Intent intent = new Intent(this, SplashScreenLoginActivity.class); // Ubah ke SplashScreenLoginActivity
                startActivity(intent);
                finish();
            } else {
